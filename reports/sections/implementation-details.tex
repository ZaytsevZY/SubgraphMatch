...
This component corresponds directly to one of the filtering strategies studied in the report. In the final experiments, it is also the main source of nonzero paper-filtered partial mappings.
...
This component corresponds to the second filtering strategy in the required ablation. In our reproduction it remains safe but conservative, which explains why its explicit pruning contribution is limited on the real datasets.
